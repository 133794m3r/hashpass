perc=0;function generate_salt(a,b,c,d){d=void 0===d?!1:d;var g=Date.now(),e="",f=7,h=1,l=8,k=9,m=1;!1===d&&(f=9,h=2,k=12,l=8,m=3);scrypt(a,c,{logN:f,r:6,p:h,encoding:"base64"},function(b){a=b});scrypt(b,a,{logN:f,r:6,p:h,encoding:"hex"},function(a){b=a});scrypt(c,b,{logN:f,r:6,p:h,encoding:"base64"},function(a){c=a});e=c+a+b;salt2=b+c+a;scrypt(e,salt2,{logN:k,r:l,p:m,encoding:"hex"},function(a){e=a});d=Date.now();console.log("gen_salt:"+(d-g)+"ms");console.log(e);return e}
