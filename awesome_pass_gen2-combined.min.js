...
(a[0]==a[1]||a[0]==g||a[1]==g)?document.getElementById("feedback").innerHTML="Do not use your username or site name in the password! "+b:2>=f.score?(console.log("hit"),document.getElementById("feedback").innerHTML=b):document.getElementById("feedback").innerHTML="Score is 3 or above and thus suggestions not necessary";!1===k?(document.getElementById("orig_time").innerHTML=display_time(f.guesses/1500),h=2):document.getElementById("orig_time").innerHTML=display_time(f.guesses/3600);b=Date.now();d=generate_salt(g,
