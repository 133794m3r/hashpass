...
(a-e)+"ms");document.getElementById("gen_score").innerHTML=f.score;document.getElementById("gen_time").innerHTML=f.crack_times_display.offline_slow_hashing_1e4_per_second;console.log(JSON.stringify(f.crack_times_display.offline_slow_hashing_1e4_per_second));modal_toggle("_progress");perc=0;alert(g+"ms")}
