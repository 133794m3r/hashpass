...
"use strict"
  ...
  function PBKDF2_HMAC_SHA256_OneIter_1(password, salt, dkLen) {
"use strict";
    // compress password if it's longer than hash block length
    password = password.length <= 64 ? password : SHA256_1(password);
...
function sha256_1(s){
"use strict";
    s=stringToUTF8Bytes1(s);
    var hash=SHA256_1(s);
    hash=bytesToHex(hash);
    return hash;
}
function pbkdf2_old(password,salt,rounds,dklen){
"use strict";
    var a='';
    var i=0;
    var pass=stringToUTF8Bytes1(password);
    var salts=stringToUTF8Bytes1(salt);
    dklen=dklen || 32
    for(i=0;i<=rounds;i++){
        a=PBKDF2_HMAC_SHA256_OneIter_1(pass,salts,dklen);
    }
    a=bytesToHex(a);
    return a;
}
